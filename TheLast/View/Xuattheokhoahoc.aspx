<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xuattheokhoahoc.aspx.cs" Inherits="TheLast.View.Xuattheokhoahoc" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label1" runat="server" Text="Chọn khoá học : "></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="KhoaHoc" DataValueField="KhoaHoc" Height="16px" Width="180px">
            </asp:DropDownList>
&nbsp;&nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StInfoConnectionString %>" SelectCommand="SELECT DISTINCT [KhoaHoc] FROM [StudentInfo]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:StInfoConnectionString %>" SelectCommand="SELECT [MSSV], [HoTen], [NgaySinh], [NoiSinh], [GioiTinh], [DanToc], [TonGiao], [DiaChiTT], [Tinh], [QuanHuyen], [CMND], [DoanDang], [SDT], [Email], [NganhHoc], [Lop] FROM [StudentInfo] WHERE ([KhoaHoc] = @KhoaHoc)">
            <SelectParameters>
                <asp:ControlParameter ControlID="DropDownList1" Name="KhoaHoc" PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </form>
</body>
